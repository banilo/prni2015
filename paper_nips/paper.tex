...
% XXX: details on data should be given as supplementary material. the section is boring for most NIPS readers
...
% XXX you haven't defined FLogReg
%
...
that disregards the autoencoder.
