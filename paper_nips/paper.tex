...
activity maps from each task (thresholded at 0.25).
...
All values are z-scored and smoothed by a Gaussian (fwhm=4).
}
\end{figure}
...
\paragraph{Support recovery -> feature identification}
\begin{itemize}
