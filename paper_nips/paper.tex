...
{\color{blue} Michael: Does this also happen when you double the task data?
i.e. rest:task 3:1, but duplicate the task data, yielding essentially 3:2?
I assume this will work, which again points to the instability of the network architecture}}
}
\end{figure}
