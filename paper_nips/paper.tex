...
Depicts the f1 score for each of 38 class predictions (chance is at $2,6\%$)
...
% rest effect
We then contemplated the impact of rest structure by modulating
...
This suggests that the autoencoder of SSFLogReg does not
behave like a classical regularization but more
...
data-rich (1000 task and 1000 task maps, \textit{cold color}) scenarios.
...
Especially the \textit{hot} curve
suggests a ``transfer learning''-type effect.
Chance is at 5,6\%.
}
\end{centering}
\label{fig_semisup}
