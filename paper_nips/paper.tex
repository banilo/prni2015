...
%
Thus, autoencoders can flexibly project the neuroimaging data
...
of the 
semi-supervised factored logistic regression (SS-F LogReg).
...
\begin{table}[h]
 ...
 \hline
 \textit{n}               & PCA + LogReg   & SPCA + LogReg  & ICA + LogReg  & AE + LogReg    & FLogReg      \\ \hline
 \multicolumn{1}{l|}{5}   & 45,1 \%        & 32,2 \%        & 37,5 \%       & 44,2 \%        & 95,7 \%      \\
 \multicolumn{1}{l|}{20}  & 78,1 \%        & 78,2 \%        & 81,0 \%       & 63,2 \%        & 97,3 \%      \\
 \multicolumn{1}{l|}{50}  & 81,7 \%        & 84,0 \%        & 84,2 \%       & 77,0 \%        & 97,6 \%      \\
 \multicolumn{1}{l|}{100} & 81,3 \%        & 82,2 \%        & 87,3 \%       & 76,6 \%        & 97,4 \%      \\ \hline
 \end{tabular}
 }
 \vspace{-0.2cm}
