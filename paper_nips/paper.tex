...
%XXX: this last statement is not cristal clear.
%
% XXX: Big gap between these two sentences. It is unclear what you call 'supervised' or 'unsupervised'.
%
...
%XXX:not exactly: the DCM is based on ROIs typically. PPI also ? 
...
%
% XXX I think that this is wrong. Moreover, it is not completely  clear how crucial this is. I think that there are better arguments to introduce the joint analysis of rest and task.
% For example, the existence of abundant RS data is an important practical reson to consider them. 'Better sample the manifold of brain states'
% 
...
%% ICA contrasts are rarely convex ?!?
...
% I would not make direct claims on *VC* dimension, since you don't consider it explictly
%
Taken together,
...
\bigskip
% XXX the accuracy figure is not very nice. export is in pdf.
% XXX change the titles. remove the resolution information from the title.
% XXX larger legends. they're not readable currently
\begin{figure}
\begin{centering}
...
% XXX To me there is no clear message here. You can always interpolate between arbitrary maps... What does this bring to you ? 
 }
\end{figure}
...
neuroimaging domain. 
%
% XXX: meaningless and useless for your work
%
...
% You really should emphasize the problem of accumulating data and knowledge which is much more interesting. Cite Yannick. 
