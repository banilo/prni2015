...
In frequently encountered data-scarce scenarios,
both training and validation
scores improved as we depart from the most supervised model ($lambda=1$).
...
In data-rich scenarios, was also present, although less pronounced.
...
Especially the \textit{cold} curve
...
Thiss favored ElasticNet regularization chosen in the above analyses.
